...
import { mockAgentSummaries, deleteAgent } from '../mock/data'
...
<template>
  <div>
    <h1 class="mb-6 text-2xl font-bold">Agents</h1>

    <DataTable :columns="['Name', 'Display Name', 'Prompt', 'Config']">
      <tr
        v-for="agent in mockAgentSummaries"
        :key="agent.name"
      ...
      >
        ...
        <td class="px-4 py-2">{{ agent.displayName }}</td>
        <td class="px-4 py-2">
          <span
            v-if="agent.hasPrompt"
